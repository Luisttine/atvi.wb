...
public class ListarConsGenero extends Listagem{
	...
	public void listar() {		
		while (true) {
			...
			case 1:
					if (clientes.size() == 0) {
						System.out.println("Não há clientes Masculinos cadastrados para este tipo de listagem!\nPor favor cadastre algum cliente com gênero Masculino ou tente outro tipo de listagem.");
					}
			...
			case 2:
				System.out.println("Não há clientes Femininos cadastrados para este tipo de listagem!\nPor favor cadastre algum cliente com gênero Feminino ou tente outro tipo de listagem.");
				i=0;
				for (Cliente cliente : clientes) {
